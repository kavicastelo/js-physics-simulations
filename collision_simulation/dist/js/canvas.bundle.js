...
/* harmony import */ var _util_elastic_collision__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./util-elastic-collision */ "./src/js/util-elastic-collision.js");
/* harmony import */ var _util_elastic_collision__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_util_elastic_collision__WEBPACK_IMPORTED_MODULE_1__);
...
var colors = ['#2185C5', '#7ECEFD', '#55FFE5', '#FF7F66']; // Event Listeners
...
function Particle(x, y, radius, color) {
  ...
  this.update = function (particles) {
    ...
    for (var i = 0; i < particles.length; i++) {
      var distance = _utils__WEBPACK_IMPORTED_MODULE_0___default.a.distance(_this.x, _this.y, particles[i].x, particles[i].y);
      if (_this === particles[i]) continue;

      if (distance - _this.radius * 2 < 0) {
        _util_elastic_collision__WEBPACK_IMPORTED_MODULE_1___default.a.resolveCollision(_this, particles[i]);
      }
    }
    ...
    if (_utils__WEBPACK_IMPORTED_MODULE_0___default.a.distance(mouse.x, mouse.y, _this.x, _this.y) < 100 && _this.opacity < 0.2) {
      _this.opacity += 0.02;
...
/***/ "./src/js/util-elastic-collision.js":
/*!******************************************!*\
  !*** ./src/js/util-elastic-collision.js ***!
  \******************************************/
